<?php
$title = "MassHealth and Health Safety Net";
require "header.php";
require "sidebar.php";
?>
<div class="col-xs-9">
    ...
    <br>
    <p>
        <strong><a href="http://www.mass.gov/?pageID=eohhs2agencylanding&L=4&sid=Eeohhs2&L0=Home&L1=Government&L2=Departments+and+Divisions&L3=MassHealth">MassHealth</a></strong> is the Medicaid program for Massachusetts. It provides health insurance to low-income residents and families.  MassHealth does cover abortions and, if you are enrolled, your care will be free.
    </p>
    <br>
    <p>
        However, there are different forms of MassHealth and not all of them cover abortion care; you will need to make sure you have or enroll in <strong>MassHealth Standard</strong>.
    </p>
    <br>
    <p>
    ...
    <br>
    <p>
        You can apply for MassHealth <strong><a href="http://www.mass.gov/?pageID=eohhs2agencylanding&L=4&sid=Eeohhs2&L0=Home&L1=Government&L2=Departments+and+Divisions&L3=MassHealth">online</a></strong> or you can file your application in person at a community health center (CHC) or hospital. Filing in person is usually the quickest way to get enrolled.  Health Care for All can also help you prepare your application.
    </p>
    <br>
    <p>
