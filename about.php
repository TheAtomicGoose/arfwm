...
<div class="col-xs-9">
    ...
    <p>
        Women can be trusted with life's important choices. We do not judge or ask you to justify the choices you make.
It should not be so hard to choose and pay for abortion care.
    </p>
    <p>
        Abortion is every woman's right, so reproductive freedom should not have a price tag.
    </p>
    <br>
    <strong>Facts about Funding for Abortion</strong><br>
    <p>
    ...
    <br>
    <ol>
        <li>advocacy to maintain and expand women's rights to abortion</li>
        <li>provision of direct services</li>
        <li>funding</li>
    </ol>
    <br>
    <p>
