$(document).ready(function() {
    ...
    function randomQuote() {
        ...
        var quoteArrEs = [
            "\"A veces la gente no entiende y no quiere entender porque no tienen que lidiar con ello cada d\xEDa. Con su ayuda he podido crear un futuro positivo para mi y para mi hija de cinco a\xF1os, y no tendr\xE9 que preocuparme acerca de un futuro abusivo. De nuevo, gracias.\"",
            ...
            "\"Nunca debemos regresar a los viejos tiempos de abortos de callej\xF3n y la penalizaci\xF3n de anticonceptivos.\"",
            "\"Sabemos que si alguien no puede pagar por un aborto, entonces no es una opci\xF3n.\"",
            "\"Toda mujer y ni\xF1a debe poder tener solo los hijos que desea. El ARFWM apoya decisiones que hacen esta visi\xF3n una realidad.\"",
            "Somos una organizaci\xF3n voluntaria, basada en la comunidad, dedicada a superar las barreras econ\xF3micas al cuidado medico relacionado con el aborto. Nuestros voluntarios y donadores dan su tiempo y apoyo porque est\xE1n comprometidos ya que saben que sin dinero, cualquier derecho no tiene significado.",
            "\"Trabajar con ARFWM me recuerda diario que aunque ya pasaron 35 a\xF1os desde Roe v. Wade, muchas mujeres de bajos ingresos no podr\xEDan obtener un aborto sin nuestra ayuda. Me da tristeza que necesitemos existir, y orgullo poder ayudar.\""
        ]
