$(document).ready(function() {
    ...
    function randomQuote() {
        ...
        var quoteArrEn = [
            "\"Sometimes people don&rsquo;t understand and don&rsquo;t really care to because they don&rsquo;t have to deal with it day to day. But with your help I am able to make a positive future for myself and my five year old girl, and not have to worry about an abusive future. Once again, thank you.\"",
            "\"It&rsquo;s the cruelest form of inequality to say that women who can afford an abortion are allowed to make choices about their bodies, while those choices are withheld from others.\"",
            "\"We must never return to the old days of the back alley abortionists and the criminalization of birth control.\"",
            "\"If someone can&rsquo;t afford an abortion, then it isn&rsquo;t available.\"",
        ...
        var quoteArrEs = [
            "\"A veces la gente no entiende y no quiere entender porque no tienen que lidiar con ello cada d&iacute;a. Con su ayuda he podido crear un futuro positivo para mi y para mi hija de cinco a&ntidle;os, y no tendr&eacute; que preocuparme acerca de un futuro abusivo. De nuevo, gracias.\"",
            ...
            "\"Nunca debemos regresar a los viejos tiempos de abortos de callej&oacute;n y la penalizaci&oacute;n de anticonceptivos.\"",
            "\"Sabemos que si alguien no puede pagar por un aborto, entonces no es una opci&oacute;n.\"",
            ...
            "Somos una organizaci&oacute;n voluntaria, basada en la comunidad, dedicada a superar las barreras econ&oacute;micas al cuidado medico relacionado con el aborto. Nuestros voluntarios y donadores dan su tiempo y apoyo porque est&aacute;n comprometidos ya que saben que sin dinero, cualquier derecho no tiene significado.",
            "\"Trabajar con ARFWM me recuerda diario que aunque ya pasaron 35 a&ntilde;os desde Roe v. Wade, muchas mujeres de bajos ingresos no podr&iacute;an obtener un aborto sin nuestra ayuda. Me da tristeza que necesitemos existir, y orgullo poder ayudar.\""
        ]
